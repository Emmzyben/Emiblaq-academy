...
$query = "SELECT id, fullName, state, nationality, dateOfbirth, email,course, phone, address, MaritalStatus, religion, qualification, passport_image_path, accreditationNumber, created_at FROM accounts WHERE accreditationNumber = ?";
$stmt = $con->prepare($query);
$stmt->bind_param("s", $matnumber);
$stmt->execute();
$stmt->bind_result($id, $fullName, $state, $nationality, $dateOfbirth, $email, $course, $phone, $address, $MaritalStatus, $religion, $qualification, $passport_image_path, $accreditationNumber, $created_at);
...
<div id="show">
        <div id="side">
            ...
            <span style="padding-left: 10px;"><h3>Emiblaq tech</h3></span>
            </div>
...
<h2 style="color:white;background-color:#2154cf;padding:20px">Personal Profile</h2>
    <div id="overview"> 
<div>
<?php
