...
<body>
  <div id="show">
        <div id="side">
            ...
            <hr>
            <ul>
                <li id="focus1"><a href="dashboard.php" style="color: #0f2765">Dashboard</a></li>
...
<div style="background-color: white; margin: 40px; height: auto; width: auto; margin-top: 10px;">
    ...
    <?php
  $query = 'SELECT id, fullName, accreditationNumber FROM accounts';
    ...
    <table >
        ...
        <?php foreach ($accounts as $account): ?>
            <tr>
                ...
                <td><?= $account['accreditation Number'] ?></td>
